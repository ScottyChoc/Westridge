<section class="certs">
        <ul>
            ...
            <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/certs/kosher.png" alt="Kosher"></li>
            <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/certs/usda.png" alt="USDA Organic"></li>
