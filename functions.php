...
add_action( 'after_setup_theme', 'westridge_localization_setup' );
function westridge_localization_setup(){
	load_child_theme_textdomain( 'westridge', get_stylesheet_directory() . '/languages' );
}
