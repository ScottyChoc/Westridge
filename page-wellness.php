...
<ul id="accord1" class="accordian">
	<li>
		<header class="accordian-header"><h4>Vitamins and Minerals</h4></header>
	...
	<li>
		<header class="accordian-header"><h4>Polyphenols</h4></header>
		<section class="accordian-section">
	...
	<li>
		<header class="accordian-header"><h4>Flavonoids</h4></header>
		<section class="accordian-section">
	...
	<li>
		<header class="accordian-header"><h4>Amino Acids</h4></header>
		<section class="accordian-section">
	...
	<li>
	<header class="accordian-header"><h4>Polysaccharides</h4></header>
	<section class="accordian-section">
	...
	<li>
	<header class="accordian-header"><h4>Antioxidants</h4></header>
	<section class="accordian-section">
